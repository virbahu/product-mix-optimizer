...
*Advanced capacity planning optimization for enterprise supply chain operations*

---

## 📋 Overview

**Product Mix Optimizer** addresses a critical challenge in modern supply chain management: capacity planning. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.

Built on the foundational work of **Professor Eliyahu Goldratt**, this tool provides supply chain professionals with an analytical framework that transforms raw operational data into actionable optimization decisions. Whether you're managing a single warehouse or a global multi-echelon network, this toolkit scales to your complexity.
...
Supply chain capacity planning is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize capacity planning typically see:
...
```bash
git clone https://github.com/virbahu/product-mix-optimizer.git
cd product-mix-optimizer
pip install -r requirements.txt
python product_mix_optimizer.py
```
...
```python
# Quick start example
from product_mix_optimizer import *
...
# See docstrings in product_mix_optimizer.py for full parameter reference
```
...
| | |
|---|---|
| **Based on** | Professor Eliyahu Goldratt, TOC Institute |
| **Key Reference** | See academic references for Professor Eliyahu Goldratt |
